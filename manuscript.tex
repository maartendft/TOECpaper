...
%\subsection{Hexagonal under uniaxial tension}
...
%Derive (analytical) expressions for failure point using Wallace tensor.
...
\subsection{Elastic instabilities and intrinsic ductility}
