...
%MDA:  you need to elaborate more on why only these two eigenvalues are relevant.  What about the other three?  Explain why they are not relevant. --> fixed
\begin{equation}
\label{eqn:Wallace3} 
...
%MDA:  You need to say what plane-wave cutoff, k-point sampling and broadening you used here also, and how well the results were converged --> I used consistent settings with the VASP calculations from before. Convergence seemed to be comparable but a bit worse. I included this info in the text.
...
%MDA:  Can you clean this up a little and make it a self-contained section?
